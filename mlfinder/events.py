...
class FindEvents():
        ...
        for i in range(len(self.stars)): 
            ...
            if a_check and d_check:
                ...
                if len(gaia_data) == 1:
                    ...
                    star_path = self.fields.find_star_path(i, parallax, mu_a, mu_d, self.bd.start, self.bd.end, step=self.bd.step)
    ...
    def event_mcmc(self, vary, which=0, samples=1000, prints=None):
        ...
        uncertainties, separations, times, indices = mcmc.sampler(prints=prints)
        
        # TEMP
        self.all_data = mcmc.all_data
        
        return uncertainties, separations, times, indices
